...
#library(data.table)
library(readxl)
Lectures <- read_excel("LectureSpring2019 copy 2.xlsx", sheet = 1, col_names = TRUE, col_types = NULL, na = "", skip = 0)
...
6. Practice your newly acquired skills with interesting, interactive, and fun projects.
...
The reading materials for this course are selected from freely available and frequently used sources online as web-books. Each of these sources have their own strengths and merits. In curating this course, I have tried to create the best fit between reading material and online courses (Datacamp). I have also tried to present a balanced mix between Data Science and classical Social Science related Instruction books. All materials linked in this course include further relevant material on a broad range of relevant topic and I encourage you to browse through them. Also, I encourage you to make use of the existing exercises within each of the here referenced resources: 
