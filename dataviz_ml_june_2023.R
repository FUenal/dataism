##                                         ##                                                  ##
##                Vizulatizations for ML Policy Support Paper June 20023                       ##
#################################################################################################
...
df <- read.csv("data/ess8_april_2023.csv")
...
# Load previous database with existing maps etc.
# load(file = "ess8.RData") Old file with worry as dv
...
# Visualizations 1: Individual level data ----
...
model_pol_ori_worry <- df %>%
  ...
  group_by(cntry) %>%
  dplyr::summarize(inctxff = survey_mean(inctxff, na.rm = T), lrscale = survey_mean(lrscale, na.rm = T), weights = survey_mean(weights, na.rm = T))
...
# library(dplyr)
# library(broom)
ds <- lm(inctxff ~ lrscale, data = model_pol_ori_worry)
...
hc_plot_1 <- model_pol_ori_worry %>% 
  hchart(
    'scatter', hcaes(x = lrscale, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Political Orientation & Fossil Fuel Taxation Policy Preferences Across Europe",
  ...
  hc_tooltip(
    ...
    pointFormat = "<b>{point.Country}</b> <br> 
                Policy support: <b>{point.inctxff:.2f}</b>  <br> 
  ...
  hc_yAxis(visible = TRUE, title = list(text = "Fossil Fuel Taxation Policy Preferences: (1) Strongly against to (5) Strongly in favour"),
           style = list(fontWeight = "bold", fontSize = "15px")) %>% 
  hc_size(height = 800) %>% 
  hc_credits(
    enabled = TRUE, 
...
# 2. Visualizations 2: Macro level data ----

## 2.1 Feature selection for viz2 ----
## Politics
...
hc_plot_cri <- model %>% 
  hchart(
    'scatter', hcaes(x = cri, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Climate Risk Index & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
  ...
  hc_tooltip(
    headerFormat = "",
    pointFormat = "<b>{point.Country}</b> <br> 
                Policy support: <b>{inctxff:.2f}</b>  <br> 
...
ds <- lm(inctxff ~ MTCO2e, data = model_z)
...
hc_plot_MTCO2e <- model_z %>% 
  hchart(
    'scatter', hcaes(x = MTCO2e, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "MTCO2e & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
# library(dplyr)
# library(broom)
ds <- lm(inctxff ~ Environmental_Health, data = model)
...
hc_plot_Environmental_Health <- model %>% 
  hchart(
    'scatter', hcaes(x = Environmental_Health, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Environmental Health & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
# library(dplyr)
# library(broom)
ds <- lm(inctxff ~ Ecosystem_Vitality, data = model)
...
hc_plot_Ecosystem_Vitality <- model %>% 
  hchart(
    'scatter', hcaes(x = Ecosystem_Vitality, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Ecosystem Vitality & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
hc_plot_EPI <- model %>% 
  hchart(
    'scatter', hcaes(x = EPI, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Environmental Performance Index & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ DMC, data = model_a)
...
hc_plot_DMC <- model_a %>% 
  hchart(
    'scatter', hcaes(x = DMC, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Domestic Material Consumption & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ Gini, data = model_b)
...
hc_plot_Gini <- model_b %>% 
  hchart(
    'scatter', hcaes(x = Gini, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Gini & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ GDP, data = model_c)
...
hc_plot_GDP <- model_c %>% 
  hchart(
    'scatter', hcaes(x = GDP, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "GDP & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ EnvironMental_Policy_Stringency, data = model_d)
...
hc_plot_EnvironMental_Policy_Stringency <- model_d %>% 
  hchart(
    'scatter', hcaes(x = EnvironMental_Policy_Stringency, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Environmental Policy Stringency & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ Green_Party_Seats_Parliament, data = model_e)
...
hc_plot_Green_Party_Seats_Parliament <- model_e %>% 
  hchart(
    'scatter', hcaes(x = Green_Party_Seats_Parliament, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Green Party Seats Parliament & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = " Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ SDO, data = model_f)
fit <- augment(ds) %>% arrange(SDO)

# Visualization
hc_plot_SDO <- model_f %>% 
  hchart(
    'scatter', hcaes(x = SDO, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Social Dominance Orientation & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ RWA, data = model_g)
fit <- augment(ds) %>% arrange(RWA)

# Visualization
hc_plot_RWA <- model_g %>% 
  hchart(
    'scatter', hcaes(x = RWA, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Right-Wing Auhtoritarianism & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ global_emissions_percent, data = model_x)
fit <- augment(ds) %>% arrange(global_emissions_percent)

# Visualization
hc_plot_global_emissions_percent <- model_x %>% 
  hchart(
    'scatter', hcaes(x = global_emissions_percent, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Global Greenhouse Gas Emissions % & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = " Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ fossil_fuel_share_energy_2019, data = model)
fit <- augment(ds) %>% arrange(fossil_fuel_share_energy_2019)

# Visualization
hc_plot_fossil_fuel_share_energy_2019 <- model %>% 
  hchart(
    'scatter', hcaes(x = fossil_fuel_share_energy_2019, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Fossil-Fuel Share Energy 2019 % & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ Policy_total, data = model_w)
fit <- augment(ds) %>% arrange(Policy_total)

# Visualization
hc_plot_Policy_total <- model_w %>% 
  hchart(
    'scatter', hcaes(x = Policy_total, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Number of Supply Side Restrcition Fossil-Fuel Policies & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ agea, data = model)
fit <- augment(ds) %>% arrange(agea)

# Visualization
hc_plot_age <- model %>% 
  hchart(
    'scatter', hcaes(x = agea, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Age & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ gndr, data = model)
fit <- augment(ds) %>% arrange(gndr)

# Visualization
hc_plot_gender <- model %>% 
  hchart(
    'scatter', hcaes(x = gndr, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Gender & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ eisced, data = model)
fit <- augment(ds) %>% arrange(eisced)

# Visualization
hc_plot_educ <- model %>% 
  hchart(
    'scatter', hcaes(x = eisced, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Education & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ gincdif, data = model)
fit <- augment(ds) %>% arrange(gincdif)

# Visualization
hc_plot_equal <- model %>% 
  hchart(
    'scatter', hcaes(x = gincdif, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Support for Equality & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ trstep, data = model)
fit <- augment(ds) %>% arrange(trstep)

# Visualization
hc_plot_trsteuparl <- model %>% 
  hchart(
    'scatter', hcaes(x = trstep, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Trust in the European Parliament & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ imbgeco, data = model)
fit <- augment(ds) %>% arrange(imbgeco)

# Visualization
hc_plot_immigr <- model %>% 
  hchart(
    'scatter', hcaes(x = imbgeco, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Immigration bad or good for country's economy & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ netusoft, data = model)
fit <- augment(ds) %>% arrange(netusoft)

# Visualization
hc_plot_intuse <- model %>% 
  hchart(
    'scatter', hcaes(x = netusoft, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Internet Usage & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ nwspol, data = model_q)
fit <- augment(ds) %>% arrange(nwspol)

# Visualization
hc_plot_nwspol <- model_q %>% 
  hchart(
    'scatter', hcaes(x = nwspol, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "News Consumption & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ ppltrst, data = model)
fit <- augment(ds) %>% arrange(ppltrst)

# Visualization
hc_plot_ppltrst <- model %>% 
  hchart(
    'scatter', hcaes(x = ppltrst, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "General Trust in People & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ basinc, data = model)
fit <- augment(ds) %>% arrange(basinc)

# Visualization
hc_plot_basinc <- model %>% 
  hchart(
    'scatter', hcaes(x = basinc, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Attitudes toward a basic income scheme & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ lkuemp, data = model)
fit <- augment(ds) %>% arrange(lkuemp)

# Visualization
hc_plot_lkuemp <- model %>% 
  hchart(
    'scatter', hcaes(x = lkuemp, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Risk of Unemployment in the Next 12 Months & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ impenv, data = model)
fit <- augment(ds) %>% arrange(impenv)

# Visualization
hc_plot_impenv <- model %>% 
  hchart(
    'scatter', hcaes(x = impenv, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Environmental Values & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ imprich, data = model)
fit <- augment(ds) %>% arrange(imprich)

# Visualization
hc_plot_imprich <- model %>% 
  hchart(
    'scatter', hcaes(x = imprich, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Materialist Values & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
ds <- lm(inctxff ~ iphlppl, data = model)
fit <- augment(ds) %>% arrange(iphlppl)

# Visualization
hc_plot_iphlppl <- model %>% 
  hchart(
    'scatter', hcaes(x = iphlppl, y = inctxff, size = weights, group = Country),
    maxSize = "10%"
  ) %>% 
  hc_add_series(
  ...
  hc_title(text = "Empathy and Helping Values & Fossil Fuel Taxation Policy Preferences Across Europe",
           style = list(fontWeight = "bold", fontSize = "30px"),
           align = "center") %>% 
  hc_subtitle(text = "Size of the bubble represents the weighted importance of the country (weighted by population and to reduce sampling error)", 
              style = list(fontWeight = "bold", fontSize = "13px"),
...
#### end ####
save.image(file = "ess8_june_2023.RData")
