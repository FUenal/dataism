...
My recommendation is to start with the textbook chapter in each module including the excersises provided in each chapter. Next, watch the associated video lectures under the respective link provided and complete each assessment associated with the lectures. After working through the textbook and video lectures, I suggest that you practice and solidify your new skills with the DataCamp courses and projects. These courses will significantly increase your learning curve since learning R is like learning a language and you will need a lot of practicing to master it!
