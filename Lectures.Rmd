...
I reccomend that you start with the textbook chapter for each module. Next, watch the associated video lectures and complete each assessment associated with the lectures. After working through the textbook and video lectures, I strongly advise that you put your new skills to the test with the DataCamp courses and projects. These courses will significantly increase your learning curve since learning R is very much like learning a new language and you will need a lot of practicing to master it!
