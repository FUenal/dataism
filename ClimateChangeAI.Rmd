...
```{r knn, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# ## KNN - Tune 
...
```{r knn1, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r c50, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# ## C5.0 
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
...
```{r c50-tune, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# ## C5.0 Tune 
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
...
```{r c50-tuned, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r naivebayes, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# library(e1071)
# 
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
...
```{r naivebayes1, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r svm, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
# ## SVM 
...
#### SVM Tune 
```{r svm-tune, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
# ## SVM -Tune 
...
```{r svm-tune1, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
...
```{r hyperparameter-tuning2, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r rpart-caret, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
...
```{r ctree-caret, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
# ## Training ctree
# # Set the seed for reproducibility
# set.seed(123, sample.kind="Rounding")
# 
...
```{r gbm-caret-plot, warning=F, message=F, echo=F, cache=TRUE}
confmat_gbm
```
...
```{r caret-ensemble1, warning=FALSE, message=FALSE, echo=FALSE, include=FALSE, cache=TRUE}
...
```{r caret-ensemble-plot, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r caret-ensemble2, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r model-accuracies, warning=FALSE, message=FALSE, echo=FALSE, cache=TRUE}
...
```{r best-model-accuracy, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
...
```{r model_comparison, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
# Box plots to compare models
scales <- list(x=list(relation="free"), y=list(relation="free"))
bwplot(results, scales=scales)
```
...
```{r best-model-accuracy1, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
best_predict_model
```

In contrast, using an Ensemble model yielded an accuracy as shown below.

```{r glm-results, message=FALSE, warning=FALSE, echo=FALSE, cache=TRUE}
stack.glm
```
