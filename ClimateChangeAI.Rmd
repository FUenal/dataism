...
As in the model hereafter, I will evaluate the accuracy by testing different hyper-tuning parameter values. The plot below shows the optimal number of `k` yielding the best accuracy score. Thus, I will subsequently run a model with this value specification.
