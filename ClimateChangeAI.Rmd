...
# Load ML data (split due to file size limitation at github)
load(file = "ml_image1.RData")
load(file = "ml_image2.RData")
# load(file = "ml_image3.RData")
# load(file = "ml_image4.RData")
